...
export function getTerminalWsUrl(taskId: string): string {
  // Use WS_BASE which points to the orchestrator, not the dashboard origin
  return `${WS_BASE}/tasks/${taskId}/terminal`;
}
